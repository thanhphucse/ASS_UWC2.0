...
<body>
    <header>
        <nav class="nav nav-pills nav-fill nav-tabs">
            ...
            <a class="nav-item nav-link active" href="../MCPs/manage_mcps.php">QUẢN LÝ MCPs</a>
            <a class="nav-item nav-link" href="../GiaoCongViec/gcv_tr.php">GIAO CÔNG VIỆC</a>
			<a class="nav-item nav-link" href="../TienDo/tiendo.php">BÁO CÁO TIẾN ĐỘ</a>
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <a href="#"><input class="btn btn-primary" type="button" value="Thêm MCP"></a>
                </div>
    ...
    <div>
        <center>
            <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1MnvaYf6aON8e65ZNaE0PMZBkPG_JZwM&ehbc=2E312F" width="480" height="360"></iframe>
        </center>
    </div>
    

    <footer>
        <h4 style="text-align:center">Organization X copyright © by Group2_L01</h4>
    </footer>
</body>
</html>
